...
export default function Builder() {
  ...
  const [bio, setBio] = useState({ name: '', dob: '', education: '', experience: '', achievements: '', linkedin: '' })  const [motivation, setMotivation] = useState({ market: '', passion: '', autonomy: '', financial: '', social: '', eduQual: '', profSkills: '', ref1: '', ref2: '' })
